...
V tuto chvíli bystě měli umět naprogramovat např. aplikaci, která zobrazuje náhodné vtipy pomocí knihovny [pyjokes](https://pypi.org/project/pyjokes/). Nebo aplikaci, která zobrazuje náhodné citáty pomocí knihovny [quoters](https://pypi.org/project/quoters/).

--- 

Jedničkáři si zkusí vyřešit [Projekt 1 - Wiki](https://cs50.harvard.edu/web/projects/1/wiki/)